...
//--  auto pattern_seleted_edges_tp = std::get<5>(ptrn_util_two.input_patterns[pl]); // boolean 
  ...
  // Test
  // /p/lscratchf/havoqgtu/RedditData/patterns_labels_vote_25/
  //if (pl >= 4) { 
  // /p/lscratchf/havoqgtu/RedditData/patterns_labels_vote_26/
  //if ((pl >= 13 && pl <= 19) || pl >= 22) { 
  // /p/lscratchf/havoqgtu/reza2_tmp/WDC_patterns_12_tree_C_2 
  //if (pl >= 8) {    
