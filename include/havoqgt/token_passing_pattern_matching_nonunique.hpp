#ifndef HAVOQGT_TOKEN_PASSING_PATTERN_MATCHING_NONUNIQUE_HPP_INCLUDED
#define HAVOQGT_TOKEN_PASSING_PATTERN_MATCHING_NONUNIQUE_HPP_INCLUDED
...
template <typename TGraph, typename VertexMetaData, typename PatternData, 
  ...
  typename VertexSetCollection, typename VertexActive, typename TemplateVertex, typename BitSet>
void token_passing_pattern_matching(TGraph* g, VertexMetaData& vertex_metadata, 
  ...
  VertexSetCollection& vertex_token_source_set, VertexActive& vertex_active, TemplateVertex& template_vertices) { // TODO: bool& pattern_found does not work, why?
  ...
  auto alg_data = std::forward_as_tuple(vertex_metadata, pattern, pattern_indices, vertex_rank, 
    ...
    edge_metadata, g, vertex_token_source_set, vertex_active, template_vertices);
...
#endif //HAVOQGT_TOKEN_PASSING_PATTERN_MATCHING_NONUNIQUE_HPP_INCLUDED
