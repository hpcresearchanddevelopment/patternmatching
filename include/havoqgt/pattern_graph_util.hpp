...
class pattern_util {
  public:
    //typedef pattern_graph_csr<Vertex, Edge, PatternType> pattern_graph;
    ...
    std::vector< std::tuple< std::vector<PatternType>, std::vector<Vertex>, Edge, bool, bool, bool> > input_patterns;  
